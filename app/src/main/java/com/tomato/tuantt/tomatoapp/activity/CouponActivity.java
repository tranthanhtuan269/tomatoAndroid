        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url_service, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof NoConnectionError) {
                    Toast.makeText(CouponActivity.this,R.string.msg_load_fail,Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(CouponActivity.this,R.string.msg_load_fail_server,Toast.LENGTH_SHORT).show();
                }
